...
#define IN "/home/vasilis/Documents/Teaching/Plymouth/COMP1001/my/github_repo/COMP1001/COMP1001-master/26_27_coursework/Report/question1/Linux/code_to_start/input_images/a30.pgm"
#define OUT "/home/vasilis/Documents/Teaching/Plymouth/COMP1001/my/github_repo/COMP1001/COMP1001-master/26_27_coursework/Report/question1/Linux/code_to_start/output_images/b30.pgm"
  ...
  for (i=0; i<M_in; i++) {
	...
	if( fscanf (finput,"%d",&temp) == EOF)
	 ...
	 for (j=0; j<N_in; j++){
	  for (i=0; i<M_in; i++) {
	c=getc(finput);
	input_image[M_in * j + i]= (unsigned char) c;
	  }
	  }
	}
else {
